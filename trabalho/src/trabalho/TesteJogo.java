...
public class TesteJogo {
	public static void main(String[] Args) {
		...
		int forcaTime1 = Integer.parseInt(JOptionPane.showInputDialog("Digite a força do time 1: " + time1.toString()));
		int forcaTime2 = Integer.parseInt(JOptionPane.showInputDialog("Digite a força do time 2: " + time2.toString()));
